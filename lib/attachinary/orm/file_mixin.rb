  ...
  module FileMixin
    def self.included(base)
      ...
      if Rails::VERSION::MAJOR == 3
        base.attr_accessible :public_id, :version, :width, :height, :format, :resource_type, :crop_x, :crop_y, :crop_w, :crop_h, :angle
      end
    ...
    def as_json(options)
      super(only: [:id, :public_id, :format, :version, :resource_type, :crop_x, :crop_y, :crop_w, :crop_h, :angle], methods: [:path])
    end
